...
dd_sample = dd_sample[~dd_sample['body'].str.contains("I am a bot", regex=False)]
dd_sample = dd_sample.loc[~(dd_sample['author'] == 'DeltaBot')]
...
random_sample = random_sample[~random_sample['body'].str.contains("I am a bot", regex=False)]
